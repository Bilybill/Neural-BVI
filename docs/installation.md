...
Use Python 3.11 and install the CPU or CUDA build of PyTorch appropriate for your system. The example defaults to CPU. Automated tests cover Linux and Windows; `requirements-tested.txt` provides the tested numerical dependency versions.
