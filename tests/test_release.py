...
@pytest.mark.parametrize("mutation", ["duplicate", "nan", "metric", "summary"])
...
def test_frozen_command_and_holdout(tmp_path, monkeypatch):
    ...
    holdout = json.loads((ROOT / "provenance/final_holdout.json").read_text())
